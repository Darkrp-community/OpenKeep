...
/datum/crafting_recipe/roguetown/cooking/raisins
	name = "raisins"
	reqs = list(/obj/item/reagent_containers/food/snacks/produce/jacksberries = 1)
	parts = list(
		/obj/item/reagent_containers/food/snacks/produce/jacksberries = 1)
	blacklist = list(/obj/item/reagent_containers/food/snacks/produce/jacksberries/poison)
...
/datum/crafting_recipe/roguetown/cooking/raisins_poison
	name = "raisins"
	reqs = list(/obj/item/reagent_containers/food/snacks/produce/jacksberries/poison = 1)
	parts = list(
		/obj/item/reagent_containers/food/snacks/produce/jacksberries/poison = 1)
