...
/obj/screen/act_intent/rogintent/update_icon(var/list/intentsl,list/intentsr, oactive = FALSE)
	..()
	cut_overlays(TRUE)
...
/obj/screen/act_intent/rogintent/proc/get_index_at_loc(var/xl, yl)
/*	if(xl<=64)
		if(xl<32)
			if(yl>16)
				return 1
...
//	winset(usr.client, "stonekeep_prefwin.character_preview_map", pick(prevcolors))
