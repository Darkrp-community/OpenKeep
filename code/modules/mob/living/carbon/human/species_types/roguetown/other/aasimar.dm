...
/datum/species/aasimar
	...
	specstats = list("strength" = 1, "perception" = -1, "intelligence" = -1, "constitution" = 0, "endurance" = 2, "speed" = 0, "fortune" = -1)
	specstats_f = list("strength" = 1, "perception" = -1, "intelligence" = 0, "constitution" = -1, "endurance" = 1, "speed" = 1, "fortune" = -1)
