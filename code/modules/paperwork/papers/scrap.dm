...
/obj/item/paper/heartfelt/goal3
	info = "Establish a diplomatic alliance with the Lord of Blackwine to strengthen the relationship between Heartfelt and Blackwine."
...
/obj/item/paper/heartfelt/goal1
	info = "Negotiate trade agreements with merchants in Blackwine to facilitate the exchange of goods and resources between the two realms."
