/datum/advclass/combat/zamurai //Not going to give this a PQ minimum since all Abyssariad races have min_pq
	...
	pickprob = 100
	tutorial = "The aristocratic zamurai serving the Warrior caste that became adrift during a expedition, losing \
	some equipments but keeping their trusty steed. They must uphold their oficial duties and following the strict \
	martial code of the Abyssal Tide."
