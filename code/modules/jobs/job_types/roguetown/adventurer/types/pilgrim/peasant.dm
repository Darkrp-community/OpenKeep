...
/datum/outfit/job/roguetown/adventurer/peasant/pre_equip(mob/living/carbon/human/H)
	..()
	H.mind.adjust_skillrank(/datum/skill/combat/wrestling, rand(0,2), TRUE)
	H.mind.adjust_skillrank(/datum/skill/combat/unarmed, rand(0,2), TRUE)
	H.mind.adjust_skillrank(/datum/skill/craft/crafting, rand(0,3), TRUE)
