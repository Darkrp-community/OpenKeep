...
/datum/advclass/pilgrim/weaver/town
	...
	outfit = /datum/outfit/job/roguetown/adventurer/seamstress/towner

/datum/outfit/job/roguetown/adventurer/seamstress/towner/pre_equip(mob/living/carbon/human/H)
	..()
	H.mind.adjust_skillrank(/datum/skill/misc/sewing, 4, TRUE)
	H.mind.adjust_skillrank(/datum/skill/craft/crafting, 3, TRUE)
