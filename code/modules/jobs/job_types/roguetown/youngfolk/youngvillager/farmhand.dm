/datum/advclass/pilgrim/farmhand
	...
	outfit = /datum/outfit/job/roguetown/adventurer/farmhand
	allowed_ages = list(AGE_YOUNG)
	isvillager = TRUE
	ispilgrim = FALSE

/datum/outfit/job/roguetown/adventurer/farmhand/pre_equip(mob/living/carbon/human/H)
	..()
	...
	shirt = shirt = /obj/item/clothing/suit/roguetown/shirt/tunic/uncolored
