...
/datum/outfit/job/roguetown/prisoner/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank(/datum/skill/combat/knives, pick(1,2), TRUE) // given Noble trait. N.
		H.mind.adjust_skillrank(/datum/skill/combat/swords, pick(1,2), TRUE) // given Noble trait. N.
