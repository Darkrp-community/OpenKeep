...
/datum/outfit/job/roguetown/royalguard/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		H.mind.adjust_skillrank(/datum/skill/combat/bows, pick(2,3,4), TRUE)
		H.mind.adjust_skillrank(/datum/skill/combat/crossbows, pick(2,3,4), TRUE)
		H.mind.adjust_skillrank(/datum/skill/combat/wrestling, pick(2,3,4), TRUE)
		H.mind.adjust_skillrank(/datum/skill/combat/unarmed, pick(2,3,4), TRUE)
		...
		H.mind.adjust_skillrank(/datum/skill/combat/shields, pick(2,3,4), TRUE)
