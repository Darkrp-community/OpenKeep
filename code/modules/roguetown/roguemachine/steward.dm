...
/obj/structure/roguemachine/steward/Topic(href, href_list)
	...
	if(href_list["payroll"])
		var/list/L = list(GLOB.noble_positions) + list(GLOB.garrison_positions) + list(GLOB.church_positions) + list(GLOB.rogue_positions) + list(GLOB.serf_positions) + list(GLOB.peasant_positions) + list(GLOB.apprentices_positions)
