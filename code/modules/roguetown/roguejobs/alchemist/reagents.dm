...
/datum/reagent/medicine/strongmana
	...
	description = "Quickly regenerates stamina."
	color = "#0000ff"
	metabolization_rate = REAGENTS_METABOLISM * 10
...
/datum/reagent/medicine/strongburnpot
...
/datum/reagent/medicine/strongburnpot/on_mob_life(mob/living/carbon/M)
...
/datum/reagent/berrypoison
	name = "Berry Poison"
	description = "Poison derived from berries."
	reagent_state = LIQUID
	color = "#00B4FF"
...
/datum/reagent/strongpoison
	name = "Strong Poison"
	description = "A very strong and deadly poison."
	reagent_state = LIQUID
	color = "#000000"
	taste_description = "burning"
	metabolization_rate = REAGENTS_METABOLISM
