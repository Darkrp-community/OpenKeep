...
// Pie Slices now exist. You're welcome, autism bakers!
/obj/item/reagent_containers/food/snacks/rogue/piedoughslice
    name = "pie smalldough"
    desc = ""
    icon = 'icons/roguetown/items/food.dmi'
    icon_state = "doughslice"
    slices_num = 0
    cooked_type = /obj/item/reagent_containers/food/snacks/rogue/cookedpiedough
...
/datum/crafting_recipe/roguetown/cooking/piedoughslicechop
    name = "split pie dough"
    reqs = list(/obj/item/reagent_containers/food/snacks/rogue/piedough = 1)
    result = list(/obj/item/reagent_containers/food/snacks/rogue/piedoughslice = 2)
    subtype_reqs = FALSE

/datum/crafting_recipe/roguetown/cooking/piedoughslicecombine
    name = "combine pie dough"
    reqs = list(/obj/item/reagent_containers/food/snacks/rogue/piedoughslice = 2)
    result = list(/obj/item/reagent_containers/food/snacks/rogue/piedough = 1)
    subtype_reqs = FALSE

/obj/item/reagent_containers/food/snacks/rogue/cookedpiedough
	name = "butter pastry"
	icon_state = "pastrypuff"
	desc = ""
	list_reagents = list(/datum/reagent/consumable/nutriment = 5)
	tastes = list("crispy buttery pastry" = 1)
