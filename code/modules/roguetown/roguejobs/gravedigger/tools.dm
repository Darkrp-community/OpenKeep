...
/obj/item/rogueweapon/shovel/getonmobprop(tag)
	...
	if(tag)
		switch(tag)
			if("gen")
				return list("shrink" = 0.6,"sx" = -21,"sy" = -20,"nx" = -7,"ny" = -20,"wx" = -13,"wy" = -19,"ex" = -9,"ey" = -20,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 0,"nturn" = 50,"sturn" = -55,"wturn" = 0,"eturn" = -23,"nflip" = 0,"sflip" = 8,"wflip" = 8,"eflip" = 0)
			if("wielded")
