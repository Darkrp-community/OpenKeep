...
/obj/item/rogueweapon/sword/long/rider
	...
	righthand_file = 'icons/mob/inhands/weapons/roguebig_righthand.dmi'
	name = "kilij scimitar"
	desc = "A curved blade of Zybantu origin, the standard sword that saw the conquest of the Zybantine continent and peoples."
	parrysound = "bladedmedium"
	swingsound = BLADEWOOSH_LARGE
	pickup_sound = 'sound/foley/equip/swordlarge2.ogg'
	bigboy = 1
...
/obj/item/rogueweapon/sword/long/marlin
	...
	righthand_file = 'icons/mob/inhands/weapons/roguebig_righthand.dmi'
	name = "shalal saber"
	desc = "A saber of Zybantu origin, in the style of the renown Shalal tribesfolk. Renown for their rumored defiance against magical properties and mastery of swordsmanship."
...
/obj/item/rogueweapon/sword/rapier/lord
	force = 20
	name = "Kings Sword"
	desc = "The regal blade of the ruler, from the first pirate founders of the isle to now, engraved with the family crest and words."
	icon_state = "lordrap"
	sellprice = 300
	max_integrity = 300
	max_blade_int = 300
...
/obj/item/rogueweapon/sword/cutlass
	name = "cutlass"
	desc = "Both tool and weapon of war, favored by Abyssor cultists for seafaring battle."
	icon_state = "cutlass"
	smeltresult = /obj/item/ingot/steel
	possible_item_intents = list(/datum/intent/sword/thrust/rapier, /datum/intent/sword/cut/rapier)
	gripped_intents = null
