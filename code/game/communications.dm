...
procs:
	...
	* parameters:
		...
		* one device may listen to several frequencies, but not same frequency twice.
	...
	* Other frequencies will be left unaffected.
...
obj/proc/receive_signal(datum/signal/signal, var/receive_method as num, var/receive_param)
	...
	* parameters:
		...
		receive_method - may be TRANSMISSION_WIRE or TRANSMISSION_RADIO. TRANSMISSION_WIRE is currently unused.
