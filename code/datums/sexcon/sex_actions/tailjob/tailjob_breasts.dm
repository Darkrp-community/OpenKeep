/datum/sex_action/tailjob_breasts
	name = "Tail breasts"
...
/datum/sex_action/tailjob_breasts/on_start(mob/living/carbon/human/user, mob/living/carbon/human/target)
	user.visible_message("<span class='danger'>[user] starts rubbing her breasts with the tail...</span>")

/datum/sex_action/tailjob_breasts/on_perform(mob/living/carbon/human/user, mob/living/carbon/human/target)
...
/datum/sex_action/tailjob_breasts/on_finish(mob/living/carbon/human/user, mob/living/carbon/human/target)
	user.visible_message("<span class='danger'>[user] stops fondling her breasts with the tail.</span>")

/datum/sex_action/tailjob_breasts/is_finished(mob/living/carbon/human/user, mob/living/carbon/human/target)
